...
This program is identical to TicTacToe.java except that it is an applet
instead of an application.  The top level component is a JApplet
instead of a JFrame, the constructor is replaced with init(), there
is no main(), and the program does not exit.
